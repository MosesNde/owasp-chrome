            ...
            if (rle_blocks > 0) {
                ...
                for (line = 0; line < 4;) {
                    ...
                    if (code < 248) {
                        ...
                        switch (code) {
                            case RLE_ESC_FC: skip_flag = 0; rle_blocks = 1; code = 253;
                            case RLE_ESC_FF: case RLE_ESC_FE: case RLE_ESC_FD:
                            ...
                            case RLE_ESC_FB:
                                ...
                                break;
                            case RLE_ESC_F9: skip_flag = 1; rle_blocks = 1;
                            case RLE_ESC_FA:
                                if (line) return IV3_BAD_RLE;
                                num_lines = 4;
                                if (cell->mv_ptr) {
                                    if (mode <= 4) {
                                        RLE_LINES_COPY;
